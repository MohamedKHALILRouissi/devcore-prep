...
class MoviesApiApi(object):
    ...
    def a_pi_most_popular_tvs_api_key_get(self, api_key, **kwargs):  # noqa: E501
        """a_pi_most_popular_tvs_api_key_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_pi_most_popular_tvs_api_key_get(api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.a_pi_most_popular_tvs_api_key_get_with_http_info(api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.a_pi_most_popular_tvs_api_key_get_with_http_info(api_key, **kwargs)  # noqa: E501
            return data

    def a_pi_most_popular_tvs_api_key_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        """a_pi_most_popular_tvs_api_key_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_pi_most_popular_tvs_api_key_get_with_http_info(api_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method a_pi_most_popular_tvs_api_key_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `a_pi_most_popular_tvs_api_key_get`")  # noqa: E501
    ...
    def a_pi_top250_tvs_api_key_get(self, api_key, **kwargs):  # noqa: E501
        """a_pi_top250_tvs_api_key_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_pi_top250_tvs_api_key_get(api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.a_pi_top250_tvs_api_key_get_with_http_info(api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.a_pi_top250_tvs_api_key_get_with_http_info(api_key, **kwargs)  # noqa: E501
            return data

    def a_pi_top250_tvs_api_key_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        """a_pi_top250_tvs_api_key_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_pi_top250_tvs_api_key_get_with_http_info(api_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method a_pi_top250_tvs_api_key_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `a_pi_top250_tvs_api_key_get`")  # noqa: E501
    ...
    def a_piimdb_list_api_key_id_get(self, api_key, id, **kwargs):  # noqa: E501
        """a_piimdb_list_api_key_id_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_piimdb_list_api_key_id_get(api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.a_piimdb_list_api_key_id_get_with_http_info(api_key, id, **kwargs)  # noqa: E501
        else:
            (data) = self.a_piimdb_list_api_key_id_get_with_http_info(api_key, id, **kwargs)  # noqa: E501
            return data

    def a_piimdb_list_api_key_id_get_with_http_info(self, api_key, id, **kwargs):  # noqa: E501
        """a_piimdb_list_api_key_id_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_piimdb_list_api_key_id_get_with_http_info(api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method a_piimdb_list_api_key_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `a_piimdb_list_api_key_id_get`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `a_piimdb_list_api_key_id_get`")  # noqa: E501
    ...
    def a_piin_theaters_api_key_get(self, api_key, **kwargs):  # noqa: E501
        """a_piin_theaters_api_key_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_piin_theaters_api_key_get(api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.a_piin_theaters_api_key_get_with_http_info(api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.a_piin_theaters_api_key_get_with_http_info(api_key, **kwargs)  # noqa: E501
            return data

    def a_piin_theaters_api_key_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        """a_piin_theaters_api_key_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_piin_theaters_api_key_get_with_http_info(api_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method a_piin_theaters_api_key_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `a_piin_theaters_api_key_get`")  # noqa: E501
