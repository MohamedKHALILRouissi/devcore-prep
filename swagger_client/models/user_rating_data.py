...
class UserRatingData(object):
    ...
    def __init__(self, im_db_id=None, title=None, full_title=None, type=None, year=None, total_rating=None, total_rating_votes=None, ratings=None, error_message=None):  # noqa: E501
